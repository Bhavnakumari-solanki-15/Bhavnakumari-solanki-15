...
def get_year_stats(repositories, year):
    ...
    total_commits, my_commits, contributors = 0, 0, set()
    ...
    for repo in repositories:
        ...
        while True:
            ...
            params = {"since": start, "until": end, "per_page": 100, "page": page}
            response = requests.get(url, headers=HEADERS, params=params)
    ...
    return {"my_commits": my_commits, "total_commits": total_commits, "contributors": len(contributors)}
